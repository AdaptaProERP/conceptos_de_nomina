...
FUNCTION A023(uPar1,uPar2,uPar3,uPar4,uPar5)
...
//------------------------------
    ...
    //SNXH2 := SNXH*CNS(102)
     VARIAC:=nHoras*nDias     //     VARIAC:=135          //nDias:=DIAS_TRAB(30)-nDiasIna
     SNXH2 :=Variac*BNoct
     nResult:=sxh4-C_A003-sxh2
