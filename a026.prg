FUNCTION A026(uPar1,uPar2,uPar3,uPar4,uPar5)
  LOCAL nResult:=0,nDiasIna:=0,nResult2:=0,nResult3:=0,nResult4:=0,nResult5:=0,nResult6:=0,nResult7:=0,nResult8:=0,nResult9:=0,nResult10:=0,nDiasIna2:=0,nResult11:=0,nResult12:=0,nResult13:=0,nResult14:=0,nResult15:=0,nResult16:=0
  LOCAL nResult17:=0,nResult18:=0,nResult19:=0,nResult20:=0,nResult21:=0,nResult22:=0,vaca:=0,nResult23:=0,nResult24:=0,nResult25:=0,nResult26:=0,nResult27:=0,nResult28:=0,nResult29:=0,nResult30:=0,nResult31:=0,nResult32:=0
...
//
     IF C_A022>0 .AND. nDiasIna<CNS(28)
         ...
         nResult31:= C_A022/11*1
     ENDIF
//

     IF C_A503>0 .AND. nDiasIna<CNS(28)
         10  // ADICIONA VALOR DE LA HORA EXTRA DIURNA
         nResult32:= C_A503/11*1
     ENDIF
...
ENDIF
  nResult:=
RETURN nResult
// EOF
